 ...
 */
const calendarEventReminderSchema = z.object({
 ...
 */
const calendarEventPersonSchema = z.object({
 ...
 */
const calendarEventAttachmentSchema = z.object({
 ...
 */
const calendarEventExtendedPropertiesSchema = z.object({
